...
<%@ page import="com.kabank.mvc.domain.FoodBean" %>
<%@ page import="java.util.*" %>
<jsp:useBean id="hamburger" class="com.kabank.mvc.domain.FoodBean" scope="request"></jsp:useBean>
<jsp:useBean id="beverage" class="com.kabank.mvc.domain.FoodBean" scope="request"></jsp:useBean>
<jsp:useBean id="coffee" class="com.kabank.mvc.domain.FoodBean" scope="request"></jsp:useBean>
<jsp:useBean id="salad" class="com.kabank.mvc.domain.FoodBean" scope="request"></jsp:useBean>
<jsp:useBean id="bagel" class="com.kabank.mvc.domain.FoodBean" scope="request"></jsp:useBean>
<jsp:useBean id="sides" class="com.kabank.mvc.domain.FoodBean" scope="request"></jsp:useBean>
<!doctype html>
<html lang="en">
