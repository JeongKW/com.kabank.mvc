...
import com.kabank.mvc.util.CreateRandomGen;
		...
		switch(servletPath.substring(1, servletPath.indexOf("."))) {
			...
			case "kakao":
				InitCommand.cmd.setSql(String.format(DmlEnum.INSERT_BANK.toString(),
					"customer_num.nextval", CreateRandomGen.createAccountNum(), "0", map.get("id")));
				break;
			case "skt":
				InitCommand.cmd.setData(CreateRandomGen.createPhoneNumber());
				InitCommand.cmd.setSql(DmlEnum.INSERT_MOBILE.toString());
				break;
		}
	}
}
